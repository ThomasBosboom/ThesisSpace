...
class OptimizationModel():
    ...
    def objective_function(self, x):
        ...
        objective_value = np.round(np.sum(x[:3]), 2)
        ...
        # results = navigation_simulator.get_navigation_results()
    ...
    def optimize(self):
        ...
        result = sp.optimize.minimize(self.objective_function, x0,
                                        ...
                                        method='Nelder-Mead',
                                        options={'maxiter': 120, "return_all": True, 'disp': True},
                                        callback=callback)
        ...
        plt.plot(np.array(design_vectors))
        plt.yscale("log")
        plt.show()
