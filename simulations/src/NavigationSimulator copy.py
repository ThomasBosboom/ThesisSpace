...
class NavigationSimulator(NavigationSimulatorBase):
    ...
    def perform_navigation(self, observation_windows, seed=0):
        ...
        for t, time in enumerate(times):
            ...
            #     # Take another snapshot after the function call
            # snapshot2 = tracemalloc.take_snapshot()
            # print("12", snapshot2.compare_to(snapshot1, 'lineno')[:1][0])
            ...
            # print("23", snapshot3.compare_to(snapshot2, 'lineno')[:1][0])
            ...
            # print("34", snapshot4.compare_to(snapshot3, 'lineno')[:1][0])
            ...
            if time in self.batch_start_times:
                ...
                # print("45", snapshot5.compare_to(snapshot4, 'lineno')[:1][0])
                ...
                # print("56", snapshot6.compare_to(snapshot5, 'lineno')[:1][0])
                ...
                # print("67", snapshot7.compare_to(snapshot6, 'lineno')[:1][0])
