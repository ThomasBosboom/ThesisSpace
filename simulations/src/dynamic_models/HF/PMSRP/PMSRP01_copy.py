...
class HighFidelityDynamicModel(DynamicModelBase):
    ...
    def set_initial_state(self):
        ...
        if self.custom_initial_state is not None:
            ...
            # initial_state_LPF = np.array([-2.45585393e+06,  8.89844774e+03, -6.57735624e+06,  6.47108515e+03, 2.97329684e+03, -2.41447080e+03])
            initial_state_LPF = np.array([212388.4875586472335272,394037.5644986266852356,106300.7374923286697594,-0.8970788856352225,0.2432130374602874,0.3186487770029039])*1000
