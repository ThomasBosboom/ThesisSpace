...
class SynodicToInertialHistoryConverter:
    ...
    def convert_primary_fixed_to_inertial_state(self, inertial_moon_state, total_rsw_to_inertial_rotation_matrix, state_body_fixed):
    ...
    def convert_synodic_to_inertial_state(self, synodic_state, inertial_moon_state):
        ...
        state_history_lumio_inertial = self.convert_primary_fixed_to_inertial_state(inertial_moon_state, total_rsw_to_inertial_rotation_matrix, initial_state_lumio_moon_fixed)
        state_history_lpf_inertial   = self.convert_primary_fixed_to_inertial_state(inertial_moon_state, total_rsw_to_inertial_rotation_matrix, initial_state_lpf_moon_fixed)
