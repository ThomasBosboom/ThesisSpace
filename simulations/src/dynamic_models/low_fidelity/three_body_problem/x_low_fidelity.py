    ...
    def set_initial_state(self):
        ...
        if self.custom_initial_state is None:
            ...
            if self.use_synodic_state:
                ...
                print("been here test: ", self.initial_state)
...
# plt.plot(states2[:,0], states2[:,1], states2[:,2], color="yellow")
# plt.plot(states2[:,6], states2[:,7], states2[:,8], color="yellow", label="states2")
