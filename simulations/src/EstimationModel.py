...
class EstimationModel:
    ...
    def set_estimator_settings(self):
        ...
        # print("truth_parameters: ", self.truth_parameters)
        ...
        # print("Random number EstimationModel: ", np.random.randint(1,1000))
...
# dynamic_model = PMSRP01.HighFidelityDynamicModel(60390, 1)


# initial_estimation_error = np.array([5e2, 5e2, 5e2, 1e-3, 1e-3, 1e-3, 5e2, 5e2, 5e2, 1e-3, 1e-3, 1e-3])
# # orbit_insertion_error = np.array([0, 0, 0, 0, 0, 0, 1e3, 1e3, 1e3, 1e-2, 1e-2, 1e-2])
# apriori_covariance = np.diag([1e3, 1e3, 1e3, 1e-2, 1e-2, 1e-2, 1e3, 1e3, 1e3, 1e-2, 1e-2, 1e-2])**2*1e-20
...
#     estimation_model.maximum_iterations = 6

#     estimation_model = estimation_model.get_estimation_results()

#     print("Best estimate: \n", estimation_model.estimation_output.parameter_history[:, estimation_model.estimation_output.best_iteration])

#     print("Final covariance: \n", np.diagonal(estimation_model.estimation_output.covariance))