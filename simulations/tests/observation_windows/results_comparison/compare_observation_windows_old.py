...
observation_windows_settings = {
    "Perilune": [
        (comparison_helper_functions.get_orbit_based_arc_observation_windows(5, margin=0.1, threshold=0.2, pass_interval=0), 1),
    ],
    "Apolune": [
        # (comparison_helper_functions.get_orbit_based_arc_observation_windows(28, margin=0.1, threshold=0.2, pass_interval=0, apolune=True), 1),
    ],
    "Random": [
