...
observation_windows_settings = {
    "Perilune": [
        (comparison_helper_functions.get_orbit_based_arc_observation_windows(8, margin=0.1, threshold=1, pass_interval=5), 1),
    ],
    "Apolune": [
        # (comparison_helper_functions.get_orbit_based_arc_observation_windows(8, margin=0.1, threshold=1, pass_interval=5, apolune=True), 1),
    ],
    "Random": [
        # (comparison_helper_functions.get_random_arc_observation_windows(8, [2, 0.5], [0.5, 0.01], [0.2, 0.01], seed=0), 1),
    ...
    "Constant": [
        # (comparison_helper_functions.get_constant_arc_observation_windows(14, 2, 1, 0.2), 1),
...
# for window_type, window_case, window_run, navigation_output in comparison_helper_functions.iterate_outputs(navigation_outputs):

#     print(f"Results for {window_type} - Case {window_case}, Run {window_run}: {navigation_output}")

#     station_keeping_results = comparison_helper_functions.station_keeping_results(navigation_output)
#     station_keeping_results[window_type][window_case][window_run] = station_keeping_results
#     station_keeping_results[window_type][window_case].update({""})

# print(station_keeping_results)
