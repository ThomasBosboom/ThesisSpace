...
observation_windows_settings = {
    "Perilune": [
        (helper_functions.get_orbit_based_arc_observation_windows(duration, margin=0.1, threshold=0.1, pass_interval=8, apolune=False, mission_start_epoch=mission_start_epoch), num_runs, None),
    ...
    "Apolune": [
        (helper_functions.get_orbit_based_arc_observation_windows(duration, margin=0.1, threshold=0.1, pass_interval=8, apolune=True, mission_start_epoch=mission_start_epoch), num_runs, None),
