...
class Particle:
    ...
    def evaluate(self,costFunc, window):
        ...
        # window = windowFunc(self.position_i)
...
class OptimizationModel:
    ...
    def particle_swarm(self, objective_function):
        ...
        self.x0 = self.generate_initial_design_vector()
        ...
        for i in range(0,self.num_particles):
            ...
            swarm.append(Particle(self.x0, seed=seed))
        ...
        while i < self.total_iterations:
            ...
            for j in range(0,self.num_particles):
                ...
                if self.has_intermediate_iteration_history(i, j):
                    ...
                    print(f"Retrieving iteration {i}, run counter {j} from cache....")
