...
if run:
        ...
        for skm_to_od_duration in skm_to_od_durations:
            ...
            for od_duration in od_durations:
                ...
                navigation_simulator = NavigationSimulator.NavigationSimulator(observation_windows,
                                                                                ...
                                                                                target_point_epochs=[skm_to_od_duration],
                                                                                step_size=1e-2)
                ...
                # delta_v_dict_per_od_duration[od_duration] = [1, 2, 3, 4]
    ...
    # utils.save_dicts_to_folder(dicts=[navigation_results_dict], labels=[], custom_sub_folder_name=file_name)
...
if run:
    ...
    for model in ["PM", "PMSRP"]:
        ...
        for num_run in range(num_runs):
            ...
            # print(skm_epochs)
            # print("od_durations: ", od_durations[:len(design_vector)])
