...
observation_windows_optim = [(60390, 60393), (60396.0, 60396.99264015196), (60399.99264015196, 60401.09730590978), (60404.09730590978, \
...
for i, navigation_results in enumerate(navigation_results_list):
    ...
    print(f"Delta V for case {i}: \n: ", navigation_results_list[i][8], np.sum(np.linalg.norm(navigation_results_list[i][8][1], axis=1)))
